---
title: "Permenhut No. 6 Tahun 2026: Membaca Arah Baru Perdagangan Karbon Kehutanan Indonesia"
date: 2026-06-22T07:00:00+07:00
draft: false
categories: ["Notes"]
image: "/images/covers/screenshot-2026-06-22-144447.png"
description: "Notulensi Seri Diskusi Perdagangan Karbon APHI & Fairatmos, 22 Juni 2026. Membahas Permenhut No. 6/2026, potensi pasar karbon kehutanan, peran pemegang PBPH, dan platform AtmosCheck sebagai alat asesmen awal kelayakan proyek"
---
...
- **Pemegang PBPH**: 10% dari nilai transaksi, dikenakan sekali per transaksi
- **Pemegang persetujuan perhutanan sosial**: 5% dari nilai transaksi
...
Platform ini dapat diakses dan dicoba secara mandiri melalui [atmoscheck.fairatmos.com](https://atmoscheck.fairatmos.com). Hasilnya bersifat indikatif dan dapat berubah mengikuti perkembangan metodologi terkini.
...
- Kompleksitas status lahan dan tumpang tindih klaim kawasan
- Ketersediaan data *baseline* tutupan lahan historis (10 tahun terakhir)
- Variasi biaya pengembangan yang cukup signifikan antar lokasi
- Ketidakpastian harga kredit karbon di pasar
- Proses FPIC dengan masyarakat yang membutuhkan waktu dan kapasitas khusus
- Kebutuhan pendanaan selama 3 hingga 5 tahun sebelum proyek mulai menghasilkan pendapatan
...
- **Operasionalisasi SRUK** (*Sistem Registri Unit Karbon*) — saat ini masih dalam proses pengembangan; registrasi sementara dilakukan melalui sistem elektronik Kementerian
- **Prosedur *nesting*** — bagaimana unit karbon proyek dapat diperhitungkan dalam program yurisdiksi, akan diatur melalui Keputusan Menteri tersendiri
- **Proses *Authorization* dan *Corresponding Adjustment*** — penting untuk perdagangan internasional dan kepatuhan terhadap Pasal 6 Perjanjian Paris
- **Peta jalan karbon kehutanan** — Kementerian Kehutanan diwajibkan menerbitkan *roadmap* ini paling lambat April 2027, yang akan menetapkan *baseline* emisi dan target area minimal 48,69 juta hektar hutan untuk mitigasi melalui pengurangan emisi, serta minimal 3,5 juta hektar lahan kritis untuk mitigasi melalui penyerapan emisi
